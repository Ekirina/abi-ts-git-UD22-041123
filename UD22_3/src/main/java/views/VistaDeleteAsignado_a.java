...
public class VistaDeleteAsignado_a extends JFrame {
	...
	public VistaDeleteAsignado_a() {
		setTitle("Eliminar proyecto asignado");
		...
		lblEnunciado = new JLabel("Señala el cientifico asignado a eliminar:");
		...
		lblEnunciado.setBounds(106, 71, 251, 20);
		...
		labelCientifico.setBounds(98, 130, 66, 14);
		...
		textCientifico.setBounds(174, 127, 96, 20);
