...
public class Tablas extends ConexionSQL{
	public static void main(String[] args) {
		...
		ConexionSQL.insertData("videoclub", "Cliente", "(id, nombre, apellido, direccion, dni, fecha) values ('1', 'Elna', 'Benbough', "
				+ "'95897 Veith Avenue', 693090, '2023-03-27');");
		ConexionSQL.insertData("videoclub", "Videos", "(id, title, director, cli_id) values ('9', 'Big', 'Penny Marshall', "
				+ "'1');");
